...
export const AuditAction = {
  ...
  VanityDomainRemoved: "vanity_domain.removed",
  TenantDomainAuthClientActivated: "tenant_domain.auth_client.activated",
  TenantDomainAuthClientDeactivated: "tenant_domain.auth_client.deactivated",
  TenantDomainRoutingLocalProven: "tenant_domain.routing.local_proven",
  TenantDomainCanonicalSet: "tenant_domain.canonical.set",
  TenantDomainCanonicalUnset: "tenant_domain.canonical.unset",
  TenantDomainDisabled: "tenant_domain.disabled",
  ...
  StorageObjectCreated: "storage_object.created",
  StorageObjectScanClean: "storage_object.scan_clean",
  StorageObjectRejected: "storage_object.rejected",
  StorageObjectDeleted: "storage_object.deleted",
