...
| ADR-ACT-0082 | ADR-0012 | Full TypeScript compiler module resolution for validate-source-imports: tsconfig-loader, module-resolver with path-alias support, TypeScript Program/CompilerHost, package exports validation, unresolved bare specifier diagnostics, resolved package/file edges. | Tooling | Done | Medium | ADR-ACT-0081 | Architecture owner / technical lead | Complete | tsconfig-loader.mjs and module-resolver.mjs added; ts.resolveModuleName with Bundler mode + synthetic paths wired; no-unresolved-alias rule added (strict); @architecture/* coverage added to no-unresolved-platform-import; --tsconfig flag added; all 31 fixture tests pass; real-repo --strict passes; v0.3.0 released |
