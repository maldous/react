...
- Result: **FULL**
- testRunId: `run-staging-1781704509-5895f7cf`
- Loki: reachable
...
| `persona-matrix:scaffold-system-admin` | false | true | 111 | OBSERVED |
...
| --- | --- | --- | --- | --- | --- |
| `pipeline-health-probe` | `cd77ee3eb38c9d9d38e4708c965f963a` | true | platform-api | true | PASSED |

## Notes

- Correlated 369 line(s); all 7 required scenario(s) observed.
- Trace cd77ee3eb38c9d9d38e4708c965f963a for 'pipeline-health-probe' matched in Tempo: services [platform-api], route true.
