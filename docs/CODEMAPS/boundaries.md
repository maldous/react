...
| ---------------------------------- | ------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- |
| no-react-in-domain                 | @platform/domain-core           | react, react-dom                                                                                                                                                                                                                                     | Pure TypeScript policy only |
| no-graphql-in-domain               | @platform/domain-core           | @apollo/_, @graphql-codegen/_, graphql                                                                                                                                                                                                               | No GraphQL client deps      |
| no-adapters-in-domain              | @platform/domain-core           | adapters-\*, react-enterprise-app, feature-workflow                                                                                                                                                                                                  | No adapter/app/feature deps |
| no-operations-in-domain            | @platform/domain-core           | api-runtime, graphql-api-runtime, worker-runtime, session-runtime, security-auth, audit-events, observability, queue-runtime, storage-runtime, config-runtime                                                                                        | No runtime/operations deps  |
| no-adapters-in-profile             | @platform/profile-configuration | adapters-postgres, adapters-clickhouse, adapters-graphql, react, react-dom                                                                                                                                                                           | Storage-independent policy  |
| no-operations-in-profile           | @platform/profile-configuration | api-runtime, graphql-api-runtime, worker-runtime, adapters-keycloak, adapters-redis, adapters-sentry, adapters-opentelemetry, adapters-object-storage, session-runtime, security-auth, observability, queue-runtime, storage-runtime, config-runtime | No operations deps          |
| no-adapters-in-access-control      | @platform/access-control        | adapters-postgres, adapters-clickhouse                                                                                                                                                                                                               | No storage deps             |
| no-react-in-access-control         | @platform/access-control        | react, react-dom                                                                                                                                                                                                                                     | Pure policy only            |
| no-operations-in-access-control    | @platform/access-control        | api-runtime, graphql-api-runtime, worker-runtime, adapters-keycloak, adapters-redis, adapters-sentry, adapters-opentelemetry, adapters-object-storage, session-runtime, security-auth, observability, queue-runtime, storage-runtime, config-runtime | No operations deps          |
...
| Rule                              | Applies To                                                  | Forbidden                                                                                                                                                                                                                                                                            | Rationale                                       |
| --------------------------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------- |
| no-raw-observability-in-domain    | domain-core, profile-configuration, access-control          | @opentelemetry/_, @sentry/_, @platform/platform-logging, @platform/platform-observability, @platform/adapters-opentelemetry, @platform/adapters-sentry, pino                                                                                                                         | No SDK direct imports                           |
...
| no-sdk-in-platform-observability  | @platform/platform-observability                            | @opentelemetry/sdk-_, @opentelemetry/auto-instrumentations-_, @opentelemetry/exporter-_, @opentelemetry/instrumentation-_, @sentry/_, @platform/adapters-_, @platform/platform-logging, pino, feature-workflow, ui-design-system, domain-core, profile-configuration, access-control | API wrapper only; SDK in adapters-opentelemetry |
...
| Rule                          | Applies To                                                                  | Forbidden                                                                                                     | Rationale                 |
| ----------------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | ------------------------- |
| no-keycloak-sdk-in-domain     | domain-core, profile-configuration, access-control, domain-identity         | @keycloak/\*, keycloak-js                                                                                     | Domain has no SDK deps    |
...
| no-disallowed-in-platform-logging            | @platform/platform-logging         | @opentelemetry/_, @sentry/_, @platform/adapters-_, @platform/platform-observability, feature-workflow, ui-design-system, domain-core, profile-configuration, access-control, contracts-_ | Pino wrapper only (ADR-0020)       |
