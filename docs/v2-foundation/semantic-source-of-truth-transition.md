...
V2 code must not drift from capability definitions or contracts. Any post-V2 behaviour change must update capability definitions, contracts, proofs, readiness semantics, operational semantics, event/cross-capability semantics where applicable, and UI semantic definitions in the same change.

The V2-readiness validator enforces this transition through R28-semantic-source-transition and the semantic artefact rules R22-R27.
