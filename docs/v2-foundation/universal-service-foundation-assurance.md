...
| Show every provider without unavailable-path proof.   |                     2324 |
| Show every workflow without failure-path proof.       |                       97 |
| Show every storage operation without lifecycle proof. |                      112 |
