...
| Audit Assurance               | PASS   | 37 mutating capabilities checked for audit event, before/after, actor, resource, timestamp, and correlation. violations=0.                                        |
...
| formal proof readiness        | FAIL   |  303 |
...
| Show every capability missing required real-provider L4 proof.    |                       62 |
