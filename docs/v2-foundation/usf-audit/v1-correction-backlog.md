...
- USF-GAP-0380: Relational storage + migrations + RLS - data-owning capability missing classification runtime proof
- USF-GAP-0381: Relational storage + migrations + RLS - data-owning capability missing retention runtime proof
- USF-GAP-0382: Relational storage + migrations + RLS - data-owning capability missing export runtime proof
- USF-GAP-0383: Relational storage + migrations + RLS - data-owning capability missing legal hold runtime proof
- USF-GAP-0384: Relational storage + migrations + RLS - data-owning capability missing DSR runtime proof
- USF-GAP-0385: Relational storage + migrations + RLS - data-owning capability missing tenant isolation runtime proof
- USF-GAP-0386: PITR, retention, legal hold, data residency - data-owning capability missing classification runtime proof
- USF-GAP-0387: PITR, retention, legal hold, data residency - data-owning capability missing export runtime proof
- USF-GAP-0388: PITR, retention, legal hold, data residency - data-owning capability missing DSR runtime proof
- USF-GAP-0389: PITR, retention, legal hold, data residency - data-owning capability missing lineage runtime proof
- USF-GAP-0390: PITR, retention, legal hold, data residency - data-owning capability missing tenant isolation runtime proof
- USF-GAP-0391: Tenant isolation proof - data-owning capability missing retention runtime proof
- USF-GAP-0392: Tenant isolation proof - data-owning capability missing backup runtime proof
- USF-GAP-0393: Tenant isolation proof - data-owning capability missing restore runtime proof
- USF-GAP-0394: Tenant isolation proof - data-owning capability missing export runtime proof
- USF-GAP-0395: Tenant isolation proof - data-owning capability missing legal hold runtime proof
- USF-GAP-0396: Tenant isolation proof - data-owning capability missing DSR runtime proof
- USF-GAP-0397: Tenant isolation proof - data-owning capability missing lineage runtime proof
- USF-GAP-0398: Tenant lifecycle: provision, suspend, delete, export - data-owning capability missing classification runtime proof
- USF-GAP-0399: Tenant lifecycle: provision, suspend, delete, export - data-owning capability missing retention runtime proof
- USF-GAP-0400: Tenant lifecycle: provision, suspend, delete, export - data-owning capability missing backup runtime proof
- USF-GAP-0401: Tenant lifecycle: provision, suspend, delete, export - data-owning capability missing restore runtime proof
- USF-GAP-0402: Tenant lifecycle: provision, suspend, delete, export - data-owning capability missing legal hold runtime proof
- USF-GAP-0403: Tenant lifecycle: provision, suspend, delete, export - data-owning capability missing lineage runtime proof
- USF-GAP-0404: Tenant lifecycle: provision, suspend, delete, export - data-owning capability missing tenant isolation runtime proof
