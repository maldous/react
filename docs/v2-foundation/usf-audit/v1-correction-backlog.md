...
- USF-GAP-0399: Tenant isolation proof - data-owning capability missing retention runtime proof
- USF-GAP-0400: Tenant isolation proof - data-owning capability missing backup runtime proof
- USF-GAP-0401: Tenant isolation proof - data-owning capability missing restore runtime proof
- USF-GAP-0402: Tenant isolation proof - data-owning capability missing export runtime proof
- USF-GAP-0403: Tenant isolation proof - data-owning capability missing legal hold runtime proof
- USF-GAP-0404: Tenant isolation proof - data-owning capability missing DSR runtime proof
- USF-GAP-0405: Tenant isolation proof - data-owning capability missing lineage runtime proof
- USF-GAP-0406: Tenant lifecycle: provision, suspend, delete, export - data-owning capability missing classification runtime proof
- USF-GAP-0407: Tenant lifecycle: provision, suspend, delete, export - data-owning capability missing retention runtime proof
- USF-GAP-0408: Tenant lifecycle: provision, suspend, delete, export - data-owning capability missing backup runtime proof
- USF-GAP-0409: Tenant lifecycle: provision, suspend, delete, export - data-owning capability missing restore runtime proof
- USF-GAP-0410: Tenant lifecycle: provision, suspend, delete, export - data-owning capability missing legal hold runtime proof
- USF-GAP-0411: Tenant lifecycle: provision, suspend, delete, export - data-owning capability missing lineage runtime proof
- USF-GAP-0412: Tenant lifecycle: provision, suspend, delete, export - data-owning capability missing tenant isolation runtime proof
- USF-GAP-0413: History read-model (read-only projection) - data-owning capability missing classification runtime proof
- USF-GAP-0414: History read-model (read-only projection) - data-owning capability missing retention runtime proof
- USF-GAP-0415: History read-model (read-only projection) - data-owning capability missing backup runtime proof
- USF-GAP-0416: History read-model (read-only projection) - data-owning capability missing restore runtime proof
- USF-GAP-0417: History read-model (read-only projection) - data-owning capability missing export runtime proof
- USF-GAP-0418: History read-model (read-only projection) - data-owning capability missing legal hold runtime proof
- USF-GAP-0419: History read-model (read-only projection) - data-owning capability missing DSR runtime proof
- USF-GAP-0420: History read-model (read-only projection) - data-owning capability missing lineage runtime proof
