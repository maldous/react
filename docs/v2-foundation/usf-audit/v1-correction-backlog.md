...
- USF-GAP-0453: Tenant domain activation (auth-client) - data-owning capability missing classification runtime proof
- USF-GAP-0454: Tenant domain activation (auth-client) - data-owning capability missing retention runtime proof
- USF-GAP-0455: Tenant domain activation (auth-client) - data-owning capability missing backup runtime proof
- USF-GAP-0456: Tenant domain activation (auth-client) - data-owning capability missing restore runtime proof
- USF-GAP-0457: Tenant domain activation (auth-client) - data-owning capability missing export runtime proof
- USF-GAP-0458: Tenant domain activation (auth-client) - data-owning capability missing legal hold runtime proof
- USF-GAP-0459: Tenant domain activation (auth-client) - data-owning capability missing DSR runtime proof
- USF-GAP-0460: Tenant domain activation (auth-client) - data-owning capability missing lineage runtime proof
- USF-GAP-0461: Tenant domain activation (auth-client) - data-owning capability missing tenant isolation runtime proof
- USF-GAP-0462: Tenant canonical domain set/unset - data-owning capability missing classification runtime proof
- USF-GAP-0463: Tenant canonical domain set/unset - data-owning capability missing retention runtime proof
- USF-GAP-0464: Tenant canonical domain set/unset - data-owning capability missing backup runtime proof
- USF-GAP-0465: Tenant canonical domain set/unset - data-owning capability missing restore runtime proof
- USF-GAP-0466: Tenant canonical domain set/unset - data-owning capability missing export runtime proof
- USF-GAP-0467: Tenant canonical domain set/unset - data-owning capability missing legal hold runtime proof
- USF-GAP-0468: Tenant canonical domain set/unset - data-owning capability missing DSR runtime proof
- USF-GAP-0469: Tenant canonical domain set/unset - data-owning capability missing lineage runtime proof
- USF-GAP-0470: Tenant canonical domain set/unset - data-owning capability missing tenant isolation runtime proof
- USF-GAP-0471: Tenant custom-domain auth callback - data-owning capability missing classification runtime proof
- USF-GAP-0472: Tenant custom-domain auth callback - data-owning capability missing retention runtime proof
- USF-GAP-0473: Tenant custom-domain auth callback - data-owning capability missing backup runtime proof
- USF-GAP-0474: Tenant custom-domain auth callback - data-owning capability missing restore runtime proof
- USF-GAP-0475: Tenant custom-domain auth callback - data-owning capability missing export runtime proof
- USF-GAP-0476: Tenant custom-domain auth callback - data-owning capability missing legal hold runtime proof
- USF-GAP-0477: Tenant custom-domain auth callback - data-owning capability missing DSR runtime proof
- USF-GAP-0478: Tenant custom-domain auth callback - data-owning capability missing lineage runtime proof
- USF-GAP-0479: Tenant custom-domain auth callback - data-owning capability missing tenant isolation runtime proof
- USF-GAP-0480: Tenant service clickthrough policy - data-owning capability missing retention runtime proof
- USF-GAP-0481: Tenant service clickthrough policy - data-owning capability missing backup runtime proof
- USF-GAP-0482: Tenant service clickthrough policy - data-owning capability missing restore runtime proof
- USF-GAP-0483: Tenant service clickthrough policy - data-owning capability missing export runtime proof
- USF-GAP-0484: Tenant service clickthrough policy - data-owning capability missing legal hold runtime proof
- USF-GAP-0485: Tenant service clickthrough policy - data-owning capability missing DSR runtime proof
- USF-GAP-0486: Tenant service clickthrough policy - data-owning capability missing lineage runtime proof
- USF-GAP-0487: Tenant service clickthrough policy - data-owning capability missing tenant isolation runtime proof
