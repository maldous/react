...
const PLATFORM_MAP = {
  ...
  "@platform/adapters-clickhouse": resolvePath(repoRoot, "packages/adapters-clickhouse/src/index.ts"),
  ...
  "@platform/adapters-object-storage": resolvePath(repoRoot, "packages/adapters-object-storage/src/index.ts"),
  "@platform/adapters-opentelemetry": resolvePath(repoRoot, "packages/adapters-opentelemetry/src/index.ts"),
  ...
  "@platform/notification-runtime": resolvePath(repoRoot, "packages/notification-runtime/src/index.ts"),
  ...
  "@platform/profile-configuration": resolvePath(repoRoot, "packages/profile-configuration/src/index.ts"),
  "@platform/feature-workflow": resolvePath(repoRoot, "packages/feature-workflow/src/index.ts"),
  "@platform/contracts-analytics": resolvePath(repoRoot, "packages/contracts-analytics/src/index.ts"),
  "@platform/contracts-graphql": resolvePath(repoRoot, "packages/contracts-graphql/src/index.ts"),
  "@platform/contracts-ingestion": resolvePath(repoRoot, "packages/contracts-ingestion/src/index.ts"),
  "@platform/graphql-api-runtime": resolvePath(repoRoot, "packages/graphql-api-runtime/src/index.ts"),
