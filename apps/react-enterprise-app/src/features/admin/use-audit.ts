...
export function useAudit(params: { resource: AuditResource; resourceId?: string }, enabled = true) {
  return useQuery({
    queryKey: ["admin", "audit", params.resource, params.resourceId ?? null] as const,
