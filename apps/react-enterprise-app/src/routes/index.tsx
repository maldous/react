...
const TOOL_LINKS: ToolLink[] = [
  ...
  },
  {
    ...
    testId: "tool-link-prometheus",
    permissions: ["platform.clickthrough.prometheus"],
  },
  {
    id: "alertmanager",
    href: "/alertmanager/",
    profile: "observability-provider",
    testId: "tool-link-alertmanager",
    permissions: ["platform.clickthrough.alertmanager"],
  },
  {
    id: "windmill",
    href: "/windmill/",
    profile: "workflow-provider",
    testId: "tool-link-windmill",
    permissions: ["platform.clickthrough.windmill"],
  },
  {
    id: "temporal",
    href: "/temporal/",
    profile: "workflow-provider",
    testId: "tool-link-temporal",
    permissions: ["platform.clickthrough.temporal"],
  },
  {
    id: "clickhouse",
